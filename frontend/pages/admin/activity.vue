    ...
    <v-card>
      ...
      <v-data-table
        ...
        <template
          ...
          <td class="text-xs-left">{{ props.item.activityAddress }}</td>
          <td class="text-xs-left">{{ formatDate(props.item.startDateTime) }}</td>
          <td class="text-xs-left">{{ props.item.activityState ? '合作中' : '合作结束' }}</td>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      {text: '活动缩略图', align: 'left', value: 'startDateTimeTime'},
      {text: '中奖率', align: 'left', value: 'activityState'},
      {text: '添加时间', align: 'left', value: 'activityState'},
      {text: '活动状态', align: 'left', value: 'activityState'},
      {text: '参与人数', align: 'left', value: 'activityState'},
      {text: '备注', align: 'left', value: 'remarks'},
      {text: '操作', align: 'left', value: 'activityName', sortable: false},
    ],
    activityList: [
      {
        id: 159,
        activityName: '海底捞',
        activityAddress: '地址地址',
